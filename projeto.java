...
public class projeto {
    ...
    public static void Temperatura() {
        ...
        System.out.println("--------------------------------------");
        System.out.println("       DADOS    DE   TEMPERATURA      ");
        System.out.println("--------------------------------------");
        for (l = 0; l < linha; l++) {
            for (c = 0; c < coluna; c++) {
    ...
    public static void Umidade() {
        ...
        System.out.println("---------------------------------");
        System.out.println("       DADOS   DE   UMIDADE      ");
        System.out.println("---------------------------------");
        for (l = 0; l < linha; l++) {
            for (c = 0; c < coluna; c++) {
                Format formato = new SimpleDateFormat("HH:mm");
    ...
    public static void Carbonico() {
        ...
        int[][] matriz = new int[linha][coluna];
        System.out.println("---------------------------------------");
        System.out.println("       DADOS   DE   GÁS CARBÔNICO      ");
        System.out.println("---------------------------------------");
        for (l = 0; l < linha; l++) {
            for (c = 0; c < coluna; c++) {
                Format formato = new SimpleDateFormat("HH:mm");
